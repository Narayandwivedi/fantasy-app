  ...
  return (
    <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-[440px] bg-white shadow-lg border-t border-gray-200 z-50 safe-area-bottom">
      <div className="flex justify-around items-center py-2 px-4">
        ...
        <Link to="/my-matches" className="flex flex-col items-center space-y-1 text-gray-500 hover:text-purple-600 transition-colors duration-200 touch-target touch-feedback p-2 -m-2 rounded-lg">
          <Trophy size={24} />
