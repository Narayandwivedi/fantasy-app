...
import { Users, Shield, Trophy, Calendar, Play, CheckCircle, UserCheck, Zap, Home, Target, Award } from 'lucide-react';
...
const Sidebar = () => {
  ...
  const getNavItemStyles = (path) => {
    ...
    return `group relative flex flex-col lg:flex-row items-center justify-center lg:justify-start w-full px-4 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 ${
      active
  ...
  return (
    <div className='relative lg:h-screen lg:max-w-[320px] bg-gradient-to-b from-slate-900 via-purple-900 to-slate-900 shadow-2xl border-r border-purple-500/20 backdrop-blur-sm'>
